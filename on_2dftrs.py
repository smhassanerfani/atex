...
font = {'font.family': 'Times New Roman', 'font.size': 8}
...
for idx, name in enumerate(dataset.classes):
    if name == "glaciers":
        ...
        ax2.scatter(X1[:, 0], X1[:, 1], marker='o', s=20,
                    alpha=0.7, c=colors, linewidths=1.0, edgecolor='k')
        ...
        # Compute KMEANS
            ...
            ax2.scatter(X1[:, 0], X1[:, 1], marker='o', s=20,
                        alpha=0.7, c=colors, linewidths=1.0, edgecolor=(0, 0, 0, 1))
